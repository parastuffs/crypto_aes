 ...
 * Library: PolarSSL
 * 
 * Note: in decryption mode, the correct tag should already be filled.
 * The data to decrypt should be set in the source string, and the decrypted
 * data will be in the output string.
 * 
